    ...
    methods: {
        makeOrder: function makeOrder(event) {
            if (!event.target.classList.contains('is-loading') && !this.submitDisabled) {
                ...
                body.html += `<div><h3>Информация о местоположении пользователя</h3> <h4>Город: <span style="font-weight: normal">${user.city}</span> </h4> <h4>Регион: <span style="font-weight: normal">${user.region}</span></h4>`;
...
new Vue({
            ...
            switch (this.procentType) {
                case 'Ежемесячно': {
                    if (this.savingsPerMonth === 0) {
                        result = 0;
                        result = (+this.savings * (1 + 0.135 * +this.period / 12)).toFixed(0);
                ...
                case 'В конце срока с капитализацией': {
                    if (this.savingsPerMonth === 0) {
                        result = 0;
                        result = (+this.savings * Math.pow(1 + 0.135 / 12, +this.period)).toFixed(0);
                        this.income = (result - this.savings).toFixed(0);
                    } else {
    ...
    methods: {
        chooseProgram: function chooseProgram() {
            var userInfo = "\n<div> \n<h3>\u0418\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F \u043E \u0437\u0430\u043A\u0430\u0437\u0435:</h3>\n                    <h4>\u0421\u0443\u043C\u043C\u0430 \u0441\u0431\u0435\u0440\u0435\u0436\u0435\u043D\u0438\u0439: <span style=\"font-weight: normal\">".concat(this.savings.toLocaleString(), "</span></h4>                    \n                    <h4>\u0421\u0443\u043C\u043C\u0430 \u043F\u043E\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u044F: <span style=\"font-weight: normal\">").concat(this.savingsPerMonth.toLocaleString(), "</span></h4>                    \n                    <h4>\u0412\u044B\u043F\u043B\u0430\u0442\u0430 \u043F\u0440\u043E\u0446\u0435\u043D\u0442\u043E\u0432: <span style=\"font-weight: normal\">").concat(this.procentType, "</span></h4>                    \n                    <h4>\u0421\u0440\u043E\u043A \u0441\u0431\u0440\u0435\u0436\u0435\u043D\u0438\u044F: <span style=\"font-weight: normal\">").concat(this.period, "</span></h4> \n                    <h4>\u0418\u0442\u043E\u0433: <span style=\"font-weight:normal\">").concat(this.result.toLocaleString(), "</span></h4>\n                    <h4>\u0412\u044B\u0433\u043E\u0434\u0430 \u043A\u043B\u0438\u0435\u043D\u0442\u0430: <span style=\"font-weight: normal\">").concat(this.income.toLocaleString(), "</span></h4>                    \n                    </div>\n                ");
...
new Vue({
    ...
    mounted: function mounted() {
        ...
        axios.get(' https://api.sypexgeo.net/json/').then(function (res) {
            ...
            user.city = res.data.city.name_ru;
            user.region = res.data.region.name_ru;
        });
    }
});
new Vue({
